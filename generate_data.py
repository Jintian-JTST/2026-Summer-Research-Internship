...
pandas_output_path = "simulated_detector_data.csv"
detector_data.to_csv(pandas_output_path, index=False)
print(f"\nSimulated data saved to {pandas_output_path}, with {len(detector_data)} events.")
