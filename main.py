...
OMEGA_C = 42.0     # 缪子动量在储藏环中的回旋角频率 (rad/us)
OMEGA_A = 1.44     # 反常自旋进动角频率 omega_a (rad/us) -> 决定了 wiggle 的频率
RADIUS = 7.112     # 储藏环半径 (米)
...
# 画出时间直方图 (Wiggle Plot)
counts, bins, _ = ax.hist(high_energy_data['Time_us'], bins=400, range=(0, 200), 
